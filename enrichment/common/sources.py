...
TEXT_GPT_5_4_NANO_PASS2B: Final[str] = "text_gpt_5_4_nano_pass2b"  # pass 2b: bathroom/cellar/shared extraction
...
VALID_SOURCES: frozenset[str] = frozenset({
    ...
    TEXT_GPT_5_4, TEXT_GPT_5_4_NANO, TEXT_GPT_5_4_NANO_PASS2B,
    PLZ_MAJORITY_VOTE,
